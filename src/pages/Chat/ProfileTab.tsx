      ...
      <div className='min-h-screen mx-auto flex flex-col items-center justify-center space-y-5'>
        ...
        <div
          ...
          <div className='space-y-3'>
            ...
            <Info
              field='phoneNumber'
              title={isVietnames ? 'số điện thoại' : 'phone number'}
...
const Info = ({ field, title, data, user, icon }: InfoProps) => {
  ...
  return (
    <form className='max-w-[90%]' onSubmit={handleSubmit}>
      {hasData && (
        <>
          {isEdit && (
            <div className='space-y-2'>
              ...
              <div className='flex items-center space-x-2'>
                ...
                <button className='btn px-[40px] py-[5px]' type='submit'>
          ...
          {!isEdit && (
            <div className='max-w-full space-x-4 flex flex-wrap items-center justify-between relative group'>
